    ...
    public function __construct($mailAuthSet)
    {
       ...
       */
        ...
        */
                    ...
                    $this->accessToken = $this->provider->getAccessToken($this->grantType, [
                    'code' => $_GET['code'],
                    'scope' => $SendOauth2C_obj->getScope(),
                    ]);

        /**
         * can be added to the interchange file for later debugging of auth failures
         */
                    $optionsD['accessToken'] = $this->accessToken;
         
      /**
       * to debug athenticationn failures, MSFT access-token fields can be displayed via https://jwt.ms
      ...
      */
       ...
       // stored code and URL-returned code don't match
            ...
            'and' . 'Locally-stored state = ' . $this->localState);
             ...
             'Especially both must have WWW prefix or both not.' . '<br />');
